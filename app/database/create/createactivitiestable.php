...
function createActivitiesTable(){
    ...
    $exe = $db->exec(
        "CREATE TABLE IF NOT EXISTS glo_activities (
          ...
          CONSTRAINT `glo_link_act_aty` FOREIGN KEY (`act_aty_fk`) REFERENCES `glo_actypes` (`aty_id`)  ON DELETE RESTRICT ON UPDATE NO ACTION
