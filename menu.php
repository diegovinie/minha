 ...
 ?>
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">Minha Administradora v0.2</a>
		</div>
		<!-- /.navbar-header -->
		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu dropdown-user">
					...
					<li class="divider"></li>
					<li><a href="<?php echo PROJECT_HOST;?>login.php"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
					</li>
				</ul>
				<!-- /.dropdown-user -->
			</li>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li>
						<a href="#">Información <span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="#">Normas</a></li>
							<li><a href="#">Seguimiento de Casos Especiales</a></li>
						</ul>
					</li>
					<li>
						...
						<ul class="nav nav-second-level">
							<li><a href="<?php echo PROJECT_HOST;?>admin/payments.php">Pagos y Recibos<span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
									<li><a href="<?php echo PROJECT_HOST;?>admin/payments.php#pagos_pendientes">Pagos Pendientes</a></li>
									<li><a href="<?php echo PROJECT_HOST;?>admin/invoices.php">Recibos</a></li>
								</ul>
							</li>
							<li><a href="<?php echo PROJECT_HOST;?>admin/bills.php">Gastos</a></li>
							<li><a href="<?php echo PROJECT_HOST;?>admin/balance.php">Estados Financieros</a></li>
							<li><a href="">Proveedores</a></li>
							<li><a href="#">Casos Especiales</a></li>
							<li><a href="#">Usuarios<span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
									<li><a href="<?php echo PROJECT_HOST;?>admin/add_user.php">Añadir Usuarios</a></li>
									<li><a href="<?php echo PROJECT_HOST;?>admin/display_users.php">Ver Usuarios</a></li>
									<li><a href="<?php echo PROJECT_HOST;?>admin/pending_users.php">Solicitudes Pendientes</a></li>
								</ul>
							</li>
					...
					?>
					<li><a href="#">Medios <span class="fa arrow"></span></a>
						<ul>
							<li><a href="#">Publicar Nota</a></li>
