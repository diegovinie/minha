    ...
    <div class="" id='apart' hidden>
        ...
        <form class="" action="add_user.php" method="post">
            <table align="center">
                ...
                <tr>
                    <td>Apartamento:</td>
                    <td><input type="text" name="number" value="1A" onblur="check_number(this)" required></td>
                </tr>
                <tr>
                    <td>Correo-e:</td>
                    <td><input type="email" name="email" value="pun@correo" onblur="lowercase(this)" required></td>
                </tr>
                <tr>
                    <td>Clave:</td>
