...
function createHabitant(/*int*/ $id=null){
    ...
    $hab['ci'] = $ci = mt_rand() % 3? genCi() : null;
    ...
    // El 14,28% no están aceptados aún.
    $hab['accepted'] = mt_rand() % 7? 1 : 0;

    // El 66% son titulares, el resto familiares.
    $hab['cond'] = mt_rand() % 3? 1 : 0;

    // Entre los titulares el 2,4% son administradores.
    $hab['role'] = $hab['cond'] == 1
        && $hab['accepted'] == 1
        && mt_rand() % 43? 1 : 2;
