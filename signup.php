...
<script src="js/forms.js" charset="utf-8"></script>
 ...
 <form class="" action="signup.php" method="post">
     <table align="center">
         ...
         <tr>
             <td>Apartamento:</td>
             <td><input type="text" name="number" value="01A" required onblur="capitalize(this);"></td>
         </tr>
         <tr>
             <td>Correo-e:</td>
     ...
     <div class="buttons1" align="center">
         ...
         <button type="button" name="button" onclick="window.location.href='login.php'">Regresar</button>
     </div>
